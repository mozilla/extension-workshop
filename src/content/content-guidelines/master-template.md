...
Your extension’s name is critical. It shows up everywhere—in search results, on [addons.mozilla.org][https://addons.mozilla.org], and in the browser itself. It’s sometimes one of the few pieces of information that a user has to determine whether or not they are interested in what you built.

Research shows that people really do take an extension’s name into account when making installation decisions. And, what you put into the extension name field becomes your URL on [addons.mozilla.org][https://addons.mozilla.org].
...
[https://addons.mozilla.org]: https://addons.mozilla.org 'addons.mozilla.org'
[screenshotRemembear]: /assets/img/content-guidelines/example-remembear.png "Screenshot Remembear" 