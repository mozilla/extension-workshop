...
Also, in both [`pageAction`][https://developer.mozilla.org/docs/Mozilla/Add-ons/WebExtensions/API/pageAction/] and [`browserAction`][browser-action] popup content is opened in a new tab and persists until the user manually closes the tab.
...
[https://developer.mozilla.org/docs/Mozilla/Add-ons/WebExtensions/API/pageAction/hide]:https://developer.mozilla.org/docs/Mozilla/Add-ons/WebExtensions/API/pageAction/hide
[https://developer.mozilla.org/docs/Mozilla/Add-ons/WebExtensions/API/pageAction/]:https://developer.mozilla.org/docs/Mozilla/Add-ons/WebExtensions/API/pageAction/