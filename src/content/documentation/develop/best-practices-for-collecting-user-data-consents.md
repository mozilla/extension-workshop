...
3. Does my extension exhange data with native applications using [NativeMessaging](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/Native_messaging)? If so, then the data exchanged needs to be declared in the data collection consent.
