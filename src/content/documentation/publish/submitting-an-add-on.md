...
Create your developer account on [addons.mozilla.org][addons-link] (AMO):
...
1. The Upload Version page displays. <br/><br/> ![Submit an add-on page][addons-before-upload]
...
::: note
When you're ready to release a new version of your add-on, update it by visiting the add-on's page on [addons.mozilla.org][addons-link] and uploading the new version. You must update it on the add-on's page, so AMO recognizes it as an update to an existing add-on and not a new one.
:::
