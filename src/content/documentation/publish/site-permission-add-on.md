...
::: note
To use your APIs in private browsing windows, the user needs to follow the instructions to [enable extensions in private windows](https://support.mozilla.org/en-US/kb/extensions-private-browsing#w_enabling-or-disabling-extensions-in-private-windows).
:::
