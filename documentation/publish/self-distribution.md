...
- [Web download](https://github.com/piculet/extension-workshop/blob/master/documentation/publish/submitting-an-add-on.md#self-distribution)—make your extension available on a suitable web accessible server and when the user downloads the signed add-on file Firefox will install it.
